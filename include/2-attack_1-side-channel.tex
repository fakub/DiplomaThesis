...
\subsubsection{Utilizing Power Traces}
	...
	\label{note:brutevssca}
		In the CPA we loop through $256$ key guesses for each of $16$ bytes, i.e., overall $256\cdot 16 = 2^{12} = 4096$ possibilities, compare with $256^{16} = 2^{128} = \ldots$ possibilities of a brute force attack.   %?% \ldots .. co s nima?
	\end{note}
