...
\label{subsec:atf}
	...
	\paragraph{Trace Visualization.}
		...
		\begin{center}
			...
			\caption{Illustrative memory trace of a run of a simple AES implementation with the first round emphasized by a red rectangle. Contents of memory writes were acquired.}   %?% poslední věta
			\label{fig:memtrace}
		\end{center}
		\end{figure}
