...
%~ The best known attack is BGE attack \cite{billet2004cryptanalysis} which is pure algebraic, on the other hand, this attack utilizes side-channel tools to attack memory traces instead.
