...
\begin{description}
	...
	\item[Bound.]
		According to our previous observation, false positives do not appear to repeat very much -- there were only a couple of repetitions for the most successful ones -- for less traces neither. %?% was? poslední kus..
