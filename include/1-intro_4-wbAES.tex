...
In this section we describe White-Box AES (WBAES) as introduced by Chow et al. \cite{chow2003aes} and reviewed by Muir \cite{muir2013tutorial} (which we recommend). Note that it has already been broken by Billet et al. \cite{billet2005cryptanalysis}, see Section \ref{sec:known}.   %!% ref to subsection, def linear?
