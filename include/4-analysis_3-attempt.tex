...
We tried to attack these intermediate values directly (i.e.\ we modified the source code of {\tt KlinecWBAES} to output them directly, no memory traces), but, for some reason, did not succeed.   %!% fakt ne???
This remains as another open question for further research.
% mam pocit že to jde ověřit výpisem mezivýsledků a útokem na ně, co si pomatuju tak to nešlo ...
