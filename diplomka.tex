...
\usepackage{geometry,amsmath, amsthm, amssymb}   % , units, dsfont, nicefrac, caption
% enumerate: \begin{enumerate}[{Example} I)] ... Roman numbering
\usepackage{graphicx,color,tabularx,float,subcaption,algorithmicx,algpseudocode,mathtools}
...
\newtheorem{notion}[remark]{Notion}
...
\DeclareMathOperator*{\AdvPRF}{Adv_{PRF}}
