...
\setcounter{tocdepth}{2}   %?% tak kolik?
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		% 	note vs. remark
		% 	\xor zkontrolovat a dát jenom tam kde se xorujou řetězce, čísla z tělesa ne!! (např sekce 3.3.5)
		...
		% 	sjednotit všechno na 1. (místo 0.)
		% 	across vs. among
		% 	umístění floatů
		% 	so far(,) ...
		% 	reference jenom jednou v kapitole
		% 	číslovaný rovnice maj referenci? jinak odebrat číslování ...
		% 	
