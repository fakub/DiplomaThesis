...
%!% odebrat citace až se dozvim jak
...
V této práci se mi podařilo reprodukovat útok na implementaci \cite{klinec2013implementation} konkrétní chráněné šifry \cite{chow2002aes}, vylepšit ho a nakonec i vysvětlit jeho podstatu, což původní autoři nezmiňují.}
...
In this thesis, we successfuly reproduced this attack against an implementation \cite{klinec2013implementation} of a specific protected cipher \cite{chow2002aes}. We further improved the original attack, and finally provided an explanation of its principle, which the original authors omitted.}
