...
\frame{
\frametitle{Rozložení úspěšnosti terčů}
	Mnoho terčů, málo měření
	\begin{itemize}
		\item shlukování terčů -- cyklické rotace vektoru
		\item zelená $\sim$ invertibilní, cihlová $\sim$ neinvertibilní prvek
		\begin{itemize}
			\item vychází z kontrukce, jen ilustrační
		\end{itemize}
	\end{itemize}
	\begin{figure}[h]
	\begin{center}
		\includegraphics[width=\textwidth]{../figures/leak_target/leak_target.pdf}
...
\frametitle{Úspěšnost podle pozice ve stopě}
	...
	\begin{figure}[h]
	\begin{center}
		\includegraphics[width=\textwidth]{../figures/leak_bit/leak_bit.pdf}
